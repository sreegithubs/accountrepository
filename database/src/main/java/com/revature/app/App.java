...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("Select 9 for aadhar number");
		System.out.println("Select 10 for date of birth");
		...
		AccDetails accdetails = new AccDetails(name0,phone,aadhar,address0,dob,balance0);
		...
		case 9:{
			AccountRepository accRepository = new JdbcAccountRepository();
			System.out.println("Enter accountid to retrieve aadhar");
			int n1 = input.nextInt();
			accountRepository.getaadharc(n1);
		}
		case 10:{
			AccountRepository accRepository = new JdbcAccountRepository();
			System.out.println("Enter accountid to retrieve aadhar");
			int n1 = input.nextInt();
			accountRepository.dobrc(n1);
		}
		}
		}
		else {
